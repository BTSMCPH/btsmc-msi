...
>
    <div class="py-4 text-gray-500 dark:text-gray-400">
        ...
        <ul class="mt-6">
            ...
            <li class="relative px-6 py-3"
                x-data="{ isMultiLevelMenuOpen: {{ json_encode(request()->routeIs(['contact-banner.*', 'messages.*',  'content.*'])) }} }">
                ...
                <ul x-show="isMultiLevelMenuOpen"
                    ...
                    <li class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200">
                        <x-responsive-nav-link href="{{ route('contact-banner.index') }}" :active="request()->routeIs('contact-banner.*')">
                            <x-slot name="icon">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
            ...
            <li class="relative px-6 py-3"
                ...
                <ul x-show="isMultiLevelMenuOpen"
                    ...
                    aria-label="submenu">
                    <li class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200">
                        <x-responsive-nav-link href="{{ route('vacancy-banner.index') }}" :active="request()->routeIs('vacancy-banner.*')">
                            <x-slot name="icon">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="m2.25 15.75 5.159-5.159a2.25 2.25 0 0 1 3.182 0l5.159 5.159m-1.5-1.5 1.409-1.409a2.25 2.25 0 0 1 3.182 0l2.909 2.909m-18 3.75h16.5a1.5 1.5 0 0 0 1.5-1.5V6a1.5 1.5 0 0 0-1.5-1.5H3.75A1.5 1.5 0 0 0 2.25 6v12a1.5 1.5 0 0 0 1.5 1.5Zm10.5-11.25h.008v.008h-.008V8.25Zm.375 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Z" />
                                </svg>
                    ...
                    <li class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200">
                        <x-responsive-nav-link href="{{ route('job.index') }}"
            ...
            <li class="relative px-6 py-3"
                x-data="{ isMultiLevelMenuOpen: {{ json_encode(request()->routeIs(['users.*', 'roles.*',  'permissions.*'])) }} }">
                <!-- Button to toggle the multi-level menu -->
                <button @click="isMultiLevelMenuOpen = !isMultiLevelMenuOpen"
                    class="inline-flex items-center justify-between w-full text-sm font-semibold text-gray-800 transition-colors duration-150 hover:text-blue-800 dark:hover:text-blue-800"
                    aria-haspopup="true" :aria-expanded="isMultiLevelMenuOpen">
