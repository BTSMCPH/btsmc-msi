    ...
    <section class="faq-page">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-8">
                    <div class="faq-page__accordion hiredots-accrodion" id="job-list-container" data-grp-name="hiredots-accrodion">
                        <!-- Include the jobs list partial -->
                        @include('pages.partials.jobs.jobs-list')
